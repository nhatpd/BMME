...
% lL = 0.0001;
lL = 0.001;
uL = 1.0001*(lam*ga^2/((1-C-epsilon)*c_2));
% lL = uL;
% uL = 1;
c = 1;
...
%     obj_h_y = c_1*0.25*(norm_y^2) + c_2*0.5*norm_y;
    ...
    for inneriter = 1:maxinneriter
        ...
        % update U, V 
        [U1, V1] = make_update_CoCaIn(U0,V0,grad_U,grad_V,grad_h_yU,grad_h_yV,c_1,c_2,uL,lam,ga);
...
%         
        ...
        x_obj = (1/2)*sum(part0.^2); %obj_func(part0, U1, V1, lam, fun_num, ga);
